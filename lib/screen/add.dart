...
class _add_screenState extends State<add_screen> {
  ...
  Future addnot() async {
    ...
    CollectionReference db = FirebaseFirestore.instance.collection("$Tsaktype");
    if (fd!.validate()) {
      fd.save();
      if(file!=null)
{
                    ...
                    onPressed: () async {
                      if (file == null)
                        AwesomeDialog(
                                context: context,
                                title: 'Info',
                                body: Text('The note will be add without image'),
